# Это, вероятно, deprecated-таблица, как и остальные, относящиеся к codes элементы.
# Пока выпиливать не стоит, несмотря на то, что практически нигде не используется
